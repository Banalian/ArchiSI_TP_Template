...
/**
 * Servlet implementation class AfficheLocationServlet
 * Gets the location chosen by the user and redirects to the view to select dates and some information for the reservation
 */
